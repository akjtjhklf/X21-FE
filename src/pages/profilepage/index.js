...
import {
    Button, Divider, Modal, DatePicker,
    Form,
    Input,
    Select,
    message,
...
const ProfilePage = () => {
    ...
    return (
        <div className="row profile-main">
            ...
            <div className="col-3">
                <img className="mb-4 text-center" src={String.fromCharCode.apply(null, user.user.avatar.data)}></img>
            ...
            <div className="col-9">
                ...
                <p className="info">{dob.getDate()}-{dob.getMonth() + 1}-{dob.getFullYear()}</p>
                <Button onClick={showModal} className="p-0 my-4"> <EditOutlined /> </Button>
                <Modal className="modal-edit"title="Cập nhật thông tin của bạn tại đây" open={isModalOpen} footer="" onCancel={handleCancel}>
                    <Form
                        {...formItemLayout}
                        form={form}
                        variant="filled"
                    ...
                    >
                        ...
                        <Button className="animate__animated animate__faster animate__zoomIn" htmlType="submit">
                            Cập nhật
                        </Button>
                    </Form>
                </Modal>
